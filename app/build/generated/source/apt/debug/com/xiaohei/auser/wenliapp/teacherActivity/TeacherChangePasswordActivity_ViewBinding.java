...
public class TeacherChangePasswordActivity_ViewBinding implements Unbinder {
  private TeacherChangePasswordActivity target;

  @UiThread
  public TeacherChangePasswordActivity_ViewBinding(TeacherChangePasswordActivity target) {
  ...
  @CallSuper
  public void unbind() {
    TeacherChangePasswordActivity target = this.target;
