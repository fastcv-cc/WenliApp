...
public class ShowWeekActivity_ViewBinding implements Unbinder {
  ...
  public ShowWeekActivity_ViewBinding(ShowWeekActivity target, View source) {
    ...
    target.send = Utils.findRequiredViewAsType(source, R.id.img_send, "field 'send'", ImageView.class);
    target.textView_maxnumber = Utils.findRequiredViewAsType(source, R.id.maxnumber, "field 'textView_maxnumber'", TextView.class);
    target.warn = Utils.findRequiredViewAsType(source, R.id.img_warn, "field 'warn'", ImageView.class);
  }
