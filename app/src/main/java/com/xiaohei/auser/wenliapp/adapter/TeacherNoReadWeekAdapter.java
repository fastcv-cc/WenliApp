...
public class TeacherNoReadWeekAdapter extends BaseAdapter {

    private List<NoReadWeekText> list = new ArrayList<>();
    private LayoutInflater layoutInflater;
    private TextView tv_reg;
    private TextView tv_time;

    public TeacherNoReadWeekAdapter(Context context, List<NoReadWeekText> list) {
